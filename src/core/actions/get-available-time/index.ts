...
import { generateTimeSlots } from "@/helper/genereteTimeSlots";
import { clinicClientActionGuard } from "@/lib/next-safe-action";

import { getAvailableTimesSchema } from "./schema";

dayjs.extend(utc);
dayjs.extend(timezone);

export const getAvailableTimes = clinicClientActionGuard
  .schema(getAvailableTimesSchema)
