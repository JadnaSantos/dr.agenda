...
import type { useUpsertPatientModel } from "./upsert-patient.model";

type upsertPatientProps = ReturnType<typeof useUpsertPatientModel>;
...
export default UpsertPatientView;
