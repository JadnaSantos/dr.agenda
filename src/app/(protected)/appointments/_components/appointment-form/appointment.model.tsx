...
import { createAppointment } from "@/core/actions/create-appointment";
import { getAvailableTimes } from "@/core/actions/get-available-time";
  ...
  useEffect(() => {
    if (selectedDoctorId) {
      ...
      if (selectedDoctor) {
        form.setValue(
          "appointmentPrice",
          selectedDoctor.appointmentPrinceInCents / 100,
        );
      }
    }
